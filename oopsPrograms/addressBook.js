...
var fs = require('fs');
var data = fs.readFileSync('../OopsPrograms/JSONfiles/addressBook.json');
var addressb = JSON.parse(data);
var name, lastname, street, city, state, nation, zip, phoneNum;
nameRestriction = /[a-z]/ig;
contactRestriction = /[0-9]/g;
function check() {
    name = readlineSync.question("Please enter your first name: ");
    if (nameRestriction.test(name) == false) {
        console.log("Invalid name!");
        return false;
    }
    lastName = readlineSync.question("Please enter your last name: ");
    if (nameRestriction.test(lastName) == false) {
        console.log("Invalid name!");
        return false;
    }
    console.log("***Address Info***");
    street = readlineSync.question("Street: ");
    city = readlineSync.question("City: ");
    if (nameRestriction.test(city) == false) {
        console.log("Invalid city name!");
        return false;
    }
    state = readlineSync.question("State: ");
    if (nameRestriction.test(state) == false) {
        console.log("Invalid state name!");
        return false;
    }
    nation = readlineSync.question("Nationality: ");
    if (nameRestriction.test(nation) == false) {
        console.log("Invalid Nationality!");
        return false;
    }
    zip = readlineSync.question("Zip code: ");
    if (contactRestriction.test(zip) == false || zip.lenght != 6) {
        console.log("Invalid zip code!");
        return false;
    }
    phoneNum = readlineSync.question("Phone number: ");
...
function addressBook() {
    ...
    console.log("2: Add Address in Old prfile ")
